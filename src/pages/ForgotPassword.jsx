...
const ForgotPassword = () => {
  ...
  return (
    <div className="min-h-screen flex  bg-radial-custom">
            <div className="p-8">
            ...
            <div className='w-full md:w-1/2 flex flex-col justify-center items-center p-8'>
                  ...
                  >
                        ...
                        <div className='mb-4'>
                        <Field type='email' name='email' placeholder='Enter your email address' className='w-full p-3 border rounded-lg focus:ring-2 focus:ring-blue-500 outline-none'/>
                        <ErrorMessage name="email" component="div" className="text-red-500 text-sm mt-1"/>
                        {message && <p className="text-green-500 text-sm mt-2">{message}</p>}
                        </div>
                        <div className='flex justify-center' >
                              <button className="mt-4 bg-custom text-white font-semibold px-6 py-2 rounded-lg hover:bg-blue-600 " type='submit'> {isSubmitting ? "Sending..." : "Send Email"}</button>
                        </div>
