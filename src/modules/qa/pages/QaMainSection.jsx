...
const QaMainSection = () => {
  ...
  useEffect(() => {
    ...
    const failedColor = randomColor({ luminosity: 'light', hue: 'red' });
    ...
    const fetchSummary = async () => {
      try {
        ...
        setSummary({
          ...
          failed_test_cases: data.failed || 0
        });
        setLoading(false);
      } catch (err) {
            ...
            {loading ? (
              ...
              <>
                ...
                <div 
                  className="p-2 rounded shadow-sm"
                  style={{ 
                    backgroundColor: cardColors.failed,
                    color: getTextColor(cardColors.failed)
                  }}
                >
                  <h3 className="text-xs font-medium">Failed TestCase</h3>
                  <p className="text-lg font-bold">{summary.failed_test_cases}</p>
                </div>
              </>
            )}
          </div>
