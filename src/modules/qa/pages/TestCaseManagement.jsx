...
const TestCaseManagement = () => {
  ...
  const handleAddTestCase = async () => {
    ...
    // Format test steps properly as an array of objects
    ...
    const testCaseData = {
      ...
      precondition: newTestCase.precondition,
      postcondition: newTestCase.postcondition,
      test_type: parseInt(newTestCase.test_type), // Ensure this is sent as a number
      due_date: newTestCase.due_date,
      assigned_users: newTestCase.assignedUsers, // This should be a simple array
  ...
  const handleAddTestType = async () => {
    ...
    try {
      ...
      // Update the selected test type to the newly added one
      ...
      // Focus back on the select element
