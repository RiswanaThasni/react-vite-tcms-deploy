...
//             {/* Project Lead */}
//             <div className="flex  space-y-1 mb-2">
//               <img
...
//                     ${selectedModuleId === module.id ? 'border-blue-500 bg-blue-50' : 'border-gray-200'}`}
//                   onClick={() => handleModuleClick(module.id)}
//                 >
//                   <div className="flex justify-between items-start mb-1">
//                     <h4 className="text-sm font-semibold text-gray-800">{module.module_name}</h4>
...
//                     </span>
//                   </div>
//                   <p className="text-gray-600 text-xs">{module.module_description}</p>
//                 </div>
//               ))}
//             </div>
//           </div>
