  ...
  return (
    <div className="container mx-auto p-4">
      ...
      <div className="bg-white rounded-lg shadow p-4 mb-4">
        <h2 className="text-lg font-semibold mb-2">Overall Performance Analysis</h2>
      ...
      {/* User Analysis Card - Changed this from grid to a full width div */}
      <div className="mb-4">
        <div className="bg-white rounded-lg shadow p-4 w-full">
          ...
          <div className="flex justify-center items-center">
            <div className="relative h-48 w-48">
              ...
              <div className="absolute bottom-4 left-0 text-xs">
                100 Active
              </div>
...
const TeamAnalysis = ({ team, stats, showDetails, toggleDetails }) => {
  return (
    <div className="bg-gray-50 p-4 rounded-lg">
      <h3 className="text-xl font-semibold mb-4">{team} Analysis</h3>
      
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
        <StatCard title="Members" value={stats.developers + stats.testEngineers} />
        <StatCard title="Tasks" value={stats.tasks} />
        <StatCard title="Completion" value={`${Math.round((stats.tasks - stats.pending) / stats.tasks * 100)}%`} />
        <StatCard title="Bugs Found" value={stats.bugs} />
      </div>
      ...
      {showDetails && (
        <div className="mt-4 p-4 bg-white rounded-lg border">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <h5 className="font-medium mb-2">Team Composition</h5>
              <ul className="list-disc pl-5">
                <li>Team Lead: John Doe</li>
                <li>Senior Members: 4</li>
                <li>Junior Members: 6</li>
              </ul>
            </div>
            
            <div>
              <h5 className="font-medium mb-2">Team Metrics</h5>
              <ul className="list-disc pl-5">
                <li>Average Task Completion: 3.2 days</li>
                <li>Bug Resolution Time: 1.5 days</li>
                <li>Team Velocity: 24 points/sprint</li>
              </ul>
            </div>
          </div>
          
          <div className="mt-4">
            <h5 className="font-medium mb-2">Team Performance Chart</h5>
            <div style={{ height: '250px' }}>
              <ResponsiveContainer width="100%" height="100%">
                <BarChart data={[
                  { sprint: 'Sprint 1', velocity: 18 },
                  { sprint: 'Sprint 2', velocity: 22 },
                  { sprint: 'Sprint 3', velocity: 24 },
                  { sprint: 'Sprint 4', velocity: 26 }
                ]}>
                  <CartesianGrid strokeDasharray="3 3" />
                  <XAxis dataKey="sprint" />
                  <YAxis />
                  <Tooltip />
                  <Bar dataKey="velocity" fill="#60a5fa" name="Velocity" />
                </BarChart>
              </ResponsiveContainer>
            </div>
          </div>
