...
const UserAnalysisChart = () => {
  ...
  const data = [
    { name: "active", value: activeUsers, color: "#E49542" },
    { name: "inactive", value: inactiveUsers, color: "#E4DFDA" },
  ];
...
>
  {data.map((entry, index) => (
    <Cell key={`cell-${index}`} fill={entry.color} />
        ...
        <div className="absolute top-20 left-50.5 flex flex-col items-center">
      ...
      <div className="flex justify-between items-center mt-3">
        <div className="flex flex-col items-center bg-green-200 p-2 rounded-lg shadow-sm">
          <p className="text-lg font-bold text-green-900">{activeUsers}</p>
          <p className="text-sm text-green-600">Active</p>
        </div>
        <div className="flex flex-col items-center bg-red-200 p-2 rounded-lg shadow-sm">
          <p className="text-lg font-bold text-red-900">{inactiveUsers}</p>
