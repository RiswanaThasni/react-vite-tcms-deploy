    ...
    <>
      ...
      <div className="hidden md:flex flex-col items-center bg-gray-100 fixed left-0 top-0 h-screen w-40 py-6 shadow-md">
        ...
        <div className="flex flex-col gap-10 left-end">
          <Link to="/dev_dashboard" className="flex items-center gap-3 p-2 hover:bg-gray-200"  onClick={() => {
        ...
        localStorage.setItem("selectedPage", "Dashboard");
          ...
          <Link to="/dev_dashboard/task_details" className="flex items-center gap-3 p-2 hover:bg-gray-200" onClick={() => { setSelectedPage("Task Details");
          localStorage.setItem("selectedPage", "Task Details"); }}>
            <img src={taskmanagement} className="w-5 h-5 cursor-pointer hover:opacity-75" alt="Project Management" />
            <span className="text-sm text-custom1 font-medium">Task Details</span>

          </Link>
          <Link to="/dev_dashboard/track_task" className="flex items-center gap-3 p-2 hover:bg-gray-200" onClick={() => { setSelectedPage("Task Tracking");
          localStorage.setItem("selectedPage", "Task Tracking");
          }}>
          <GiProgression size={20} className=" text-violet-950" />
          <span className="text-sm text-custom1 font-medium">Track Task</span>
          </Link>
