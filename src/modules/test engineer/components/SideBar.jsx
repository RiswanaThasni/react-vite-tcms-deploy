...
import { FiMenu, FiX, FiLogOut, FiGrid, FiList } from "react-icons/fi";
...
const SideBar = ({ isSidebarOpen, setIsSidebarOpen }) => {
  ...
  const NavButton = ({ Icon, alt, path }) => {
    const isActive = location.pathname === path || 
      (path === "/testengineer_dashboard" && 
        ["/testengineer_dashboard", "/testengineer_dashboard/", "/testengineer_dashboard/mainsection"].includes(location.pathname));
