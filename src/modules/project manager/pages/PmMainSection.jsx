...
import React, { useEffect, useState } from 'react';
import { Calendar, Search, MoreHorizontal, ChevronLeft, ChevronRight, ChevronsLeft, ChevronsRight } from 'lucide-react';
import { useDispatch, useSelector } from 'react-redux';
import { useNavigate } from 'react-router-dom';
import { getProjects } from '../../../redux/slices/projectSlice'
import randomColor from 'randomcolor'; 
      ...
      <div className='p-1 md:p-3 grid grid-cols-8 gap-6'>
        <div className="flex flex-col col-span-6 lg:flex-row gap-3">
          <div className="flex-1">
            ...
            {/* Updated Pagination Controls to match ProjectManagement style */}
                ...
                <button
                  ...
                  className={`px-4 py-2 rounded ${
                    currentPage === 1 
                      ...
                      : 'bg-sidebar-hover text-white hover:bg-lime-300'
                  }`}
                >
